 ...
 * @author Kerry
 * */
public class StartDialogView extends View{
	...
	public StartDialogView(Context context, AttributeSet attrs) {
		super(context, attrs);
...
//		moveHeight = 0;
	...
	public void show(){
		if(!isShow){
			StartDialogView.this.startMoveAnim(0, -(int)(mHeight+tabHeight), mDuration);
			isShow = true;
			changed();
		}
	}
	...
	public void dismiss(){
		if(isShow){
			StartDialogView.this.startMoveAnim(-(int)(mHeight+tabHeight), (int)(mHeight+tabHeight), mDuration);
			isShow = false;
			changed();
		}
	}
